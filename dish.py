...
def bubble_obs(l, b, jd, nspec):
    ...
    try:
        ...
        spectrometer.read_spec(jd+'_nd1.fits', nspec, (l,b), 'ga')
        print('Deactivating noise diode')
        noise.off()
        print('Gathering Spectra (diode off)')
        spectrometer.read_spec(jd+'_nd0.fits', nspec, (l,b), 'ga')
    except AssertionError:
        print('YOU FOOL: You pointed the telescope out of bounds')
        break
